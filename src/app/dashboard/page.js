...
//       return setAlert({ type: 'error', message: 'No members to email' });
...
//         message: `Dear team member, this is an important warning email from the ${team.name} team.`
//       })
//     });

//     const data = await res.json();
//     if (data.success) {
//       setAlert({ type: 'success', message: `Warning emails sent for team ${team.name}` });
//     } else {
//       setAlert({ type: 'error', message: `Email failed: ${data.error}` });
//     }
//   } catch (err) {
//     console.error(err);
