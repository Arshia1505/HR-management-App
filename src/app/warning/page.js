...
//   const handleSendWarning = async (selectedIds) => {
//     const subject = prompt('Enter warning email subject:');
...
//       body: JSON.stringify({ memberIds: selectedIds, subject, body })
//     });
//     alert('Warning emails sent!');
//   };
...
//         <h1 className="text-2xl font-semibold mb-4">Send Warning Emails</h1>
//         <MemberList members={members} onSend={handleSendWarning} />
//       </div>
//     </div>
//   );
// }
